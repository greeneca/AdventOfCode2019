module P152
  class P152
    ...
    def calculate_o2_spread
      while @map.select{|k,v| v == 1}.count > 0
        @map.select{|k,v| v == 2}.each do |k,v|
          @moves.each do |move|
            if @map[k+move[1]] == 1
              @map[k+move[1]] = 2
            end
    ...
    def printMap
      ...
      print print_screen
      puts "Moves Made: #{@moves_made.count}, Monuts Passed: #{@minutes}"
    end
